...
class KalmanBoxTracker(object):
    ...
    def __init__(self, bbox, cls, det_ind, delta_t=3):
        ...
        self.kf.initiate(
            measurement=convert_bbox_to_z_dtc(bbox=bbox)
        )  # DEB
    ...
    def update(self, bbox, cls, det_ind):
        ...
        if bbox is not None:
            ...
            self.hit_streak += 1
            self.kf.update(
                measurement=convert_bbox_to_z_dtc(bbox)
            ) 
        # else:
    ...
    def predict(self):
        ...
        self.history.append(convert_x_to_bbox_dtc(x=self.kf.mean))
    ...
    def get_state(self):
        ...
        print("-" * 75)  # DEB
        return convert_x_to_bbox_dtc(x=self.kf.mean)
...
class OCSORT_DTC(object):
    def __init__(self,
        ...
        BaseTrack.clear_count()  # DEB

        self.kalman_filter = KalmanFilter()  # DEB
    ...
    def update(self, dets, img):
        ...
        if USE_CMC:
            ...
            KalmanBoxTracker.multi_gmc_dtc(self.trackers, warp)  # DEB
        # # =======================================================
